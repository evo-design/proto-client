...
def main() -> None:
    ...
    # Prepend a "generated" banner to each output (as a comment so we don't
    # step on the source file's module docstring).
    banner = (
    ...
    for name in SYNC_TARGETS:
        ...
        if not content.startswith("# AUTO-GENERATED"):
            out.write_text(banner.format(name=name) + content)
